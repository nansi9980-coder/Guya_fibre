...
const NODES: ArchNode[] = [
  ...
  },
  {
    ...
    icon: Cable,
    color: "#2C5F8A",
    description: "Câble optique de forte capacité reliant le NRA au PM. Constitue l'épine dorsale du réseau FTTH et supporte l'ensemble du trafic agrégé.",
    details: [
  ...
  },
  {
    ...
    icon: Building2,
    color: "#102A3E",
    description: "Infrastructure passive verticale à l'intérieur d'un immeuble, reliant le BL aux prises terminales optiques (PTO) de chaque étage et appartement.",
    details: [
        ...
        <div className="max-w-3xl mb-16">
          ...
          <ScrollReveal delay={2}>
            <p className="text-muted-foreground text-lg md:text-xl leading-relaxed text-pretty max-w-2xl">
              Du NRA jusqu'à l'abonné — infrastructure passive et active de bout en bout.{" "}
