...
const translationsBase = {
  fr: {
    ...
    hero: {
      title: "L'expertise fibre au cœur de la Guyane.",
      subtitle: "Conception, déploiement et maintenance de réseaux optiques haute performance — de Cayenne aux zones isolées.",
    ...
    stats: {
      ...
      availability: "Couverture Territoire",
      km: "Km de fibre opérationnelle",
    },
    services: {
